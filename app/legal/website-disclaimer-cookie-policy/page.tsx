...
export default function WebsiteDisclaimerCookiePolicyPage() {
  return (
    <>
      <BreadcrumbJsonLd items={[{ name: "Home", url: "https://rkmfoundation.com/" }, { name: "Legal & Governance", url: "https://rkmfoundation.com/legal" }, { name: "Website Disclaimer & Cookie Policy", url: "https://rkmfoundation.com/legal/website-disclaimer-cookie-policy" }]} />
